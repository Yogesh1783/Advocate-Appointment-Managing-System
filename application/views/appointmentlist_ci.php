            ...
            <div class="main-content pt-0">
                <div class="container">
                        ...
                        <div class="page-header">
                            ...
                            <div class="page-header-1">
                              <a href="<?php echo base_url('index.php/Client/addappointment_ci')?>"><button class="btn ripple btn-main-primary" style="background-color: blue;">Add appointmentment</button></a>
                            </div>
                ...
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer justify-content-center">
                            <a href="<?php echo base_url('index.php/client/deleteAppointment/'.$appointment->AppointmentClientId)?>"><button 
