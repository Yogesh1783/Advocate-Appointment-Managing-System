        ...
        <div class="page">
                        ...
                        <div class="dropdown main-profile-menu">
                            ...
                            <div class="dropdown-menu">
                                <div class="header-navheading">
                                    <h6 class="main-notification-title"><?php echo $_SESSION['ClientEmail']; ?></h6>
                                    <p class="main-notification-text">User</p>
                                </div>
                        ...
                        <div class="d-flex order-lg-2 ml-auto">
                            ...
                            <div class="dropdown main-profile-menu">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item" href="<?php echo base_url('index.php/patient/login_pt')?>">
                                        <i class="fe fe-power"></i> Sign Out
                                    </a>
                                </div>
                            </div>
            ...
            <div class="main-navbar hor-menu sticky">
                <div class="container">
                    <ul class="nav">
                         <li class="nav-item">
                            <a class="nav-link font-weight-semibold" href="client"> Dashboard</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link font-weight-semibold" href="advocatelist_ci"> Advocate</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link font-weight-semibold" href="appointmentlist_ci"> Appointment</a>       
                        </li>
