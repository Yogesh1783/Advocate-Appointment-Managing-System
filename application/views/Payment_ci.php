<!-- Main Content-->
            <div class="main-content pt-0">
                <div class="container">
                    <form action="<?php echo base_url('index.php/Home/insertTransacton'); ?>" method="POST">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="col-md-9 mg-t-5 mg-md-t-0">
                                                    <input class="form-control" name="ClientAccountHolderName" placeholder="" type="text" required pattern="[a-z , A-Z]*" title="Please enter alphabets only">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-4 mg-t-10 mg-lg-t-0 mb-3">
                                                ...
                                                <div class="col-md-9 mg-t-5 mg-md-t-0">
                                                    <input class="form-control" name="ClientAccountNumber" placeholder="" type="Text" required >
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-4 mg-t-10 mg-lg-t-0 mb-3">
                                                ...
                                                <div class="col-md-9 mg-t-5 mg-md-t-0">
                                                    <input class="form-control" name="ClientTransferedAmount" required >
                                                </div>
                                            </div>   
                                        </div>
                                        ...
                                        <div class="row row-sm mg-t-20">
                                            <div class="col-lg-4 mg-t-10 mg-lg-t-0 mb-3">
                                                ...
                                                <div class="col-md-9 mg-t-5 mg-md-t-0">
                                                    <input class="form-control" name="ClientUTRID" placeholder="" type="Text" required>
                                                </div>
                                            </div>
