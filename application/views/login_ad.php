                        ...
                        <div class="card">
                            <div class="">
                                <div class="card-body mt-2 mb-2 p-5">
                                    ...
                                    <form action="<?php echo base_url('index.php/admin/verifylogin'); ?>" method="POST" >
                                        <h5 class="text-left mb-3">Sign In</h5>
                                        ...
                                        <div class="form-group text-left">
                                            ...
                                            <input class="form-control rounded-11" placeholder="Users email" name="AdminEmail" type="text">
                                             
                                        </div>
                                        <div class="form-group text-left">
                                            <label class="">Password</label>
                                            <input class="form-control rounded-11" placeholder="password" name="AdminPassword" type="password">
