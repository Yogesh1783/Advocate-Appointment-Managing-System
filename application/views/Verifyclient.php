                                                  ...
                                                  foreach($clients as $client)
                                                    ...
                                                    <tr>
                                                       <td><?php echo $index?></td>
                                                        <td><?php echo $client->Reg_ClientName?></td>
                                                        <td><?php echo $client->Reg_ClientAge?></td>
                                                        <td><?php echo $client->Reg_ClientGender?></td>
                                                        
                                                         <td><?php echo $client->Reg_ClientCaseType?></td>
                                                         <td><?php echo $client->Reg_ClientMobileno?></td>
                                                         <td><?php echo $client->Reg_ClientEmail?></td>
                                                         <td><?php echo $client->CaseType?></td>
                                                        <td><a href="<?php echo base_url('index.php/Admin/update_client_ad/'.$client->Reg_ClientId)?>"><i  class="fe fe-edit-3"></i></a>
                                                         &nbsp;
                                                            <a data-target="#modaldemo2<?php echo $client->Reg_ClientId;?>" data-toggle="modal" ><i  class="fe fe-trash-2"></i></a></td>
                                                        
                                                        <div class="modal" id="modaldemo2<?php echo $client->Reg_ClientId;?>">
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <?php echo $client->Reg_ClientId;?>
                        </div>
                        <div class="modal-footer justify-content-center">
                            <a href=<?php echo base_url('index.php/Admin/deleteClient/'.$client->Reg_ClientId)?>"><button 
