<!-- Main Content-->
            <div class="main-content pt-0">
                <div class="container">
                    <form action="<?php echo base_url('index.php/client/insertAdvocate'); ?>" method="POST">
                       ...
                       <?php echo form_open('adddoctor_ad'); ?>
                        ...
                        <div class="page-header">
                            ...
                            <div class="page-header-1">
                             <button class="btn ripple btn-main-primary" style="background-color: blue;"> <a style="color:white" href="<?php echo base_url('index.php/client/advocatelist_ci')?>">View Advocate</a></button>
                            </div>
                        </div>
                        <!-- End Page Header -->
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row row-sm mg-t-20">
                                            <div class="col-lg-4 mg-t-10 mg-lg-t-0 mb-3">
                                                ...
                                                <div class="col-md-9 mg-t-5 mg-md-t-0">
                                                    <input class="form-control" name="AdminAdvocateMobile" placeholder="" type="Text" requiredpattern="[0-9]{10}" title="Please enter the valid mobile no" required>
                                                </div>
                                            </div>
