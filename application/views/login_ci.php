                        ...
                        <div class="card">
                            <div class="">
                                ...
                                <div class="card-body mt-2 mb-2 p-6">
                                    ...
                                    <h5 class="text-left mb-3">Client Login</h5>
                                        

                                    <div class="page-header-1">
                                        <div class="mb-3">
                            <button class="btn ripple btn-main-primary" style="background-color: blue;"> <a style="color:white" href="<?php echo base_url('index.php/client/login_ci')?>">Client</a></button>
                            <button class="btn ripple btn-main-primary" style="background-color: blue;"> <a style="color:white" href="<?php echo base_url('index.php/advocate/login_adv')?>">Advocate</a></button>
                            <button class="btn ripple btn-main-primary" style="background-color: blue;"> <a style="color:white" href="<?php echo base_url('index.php/home/home')?>">Home</a></button>
                                    ...
                                    <form id="loginForm" action="<?php echo base_url('index.php/client/verifylogin'); ?>" method="POST" >

                                        <div class="form-group text-left">
                                            <label class="">Email Address</label>
                                            <input class="form-control rounded-11" placeholder="Users email" name="ClientEmail" type="text" required>
                                             
                                        </div>
                                        <div class="form-group text-left">
                                            <label class="">Password</label>
                                            <input class="form-control rounded-11" placeholder="password" name="ClientPassword" type="password" required>
