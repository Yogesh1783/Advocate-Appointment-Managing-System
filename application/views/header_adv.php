...
<head>
    <meta charset="utf-8">
        ...
        <!-- Title -->
        <title>AMS-Advocate Management System</title>
                ...
                <div class="container">
                    ...
                    <div class="main-header-center">
                        <div class="responsive-logo">
                            <a href="index.html"><img src="../../assets/img/brand/logo1.png" class="mobile-logo" alt="logo"></a>
                        ...
                        <div class="dropdown main-profile-menu">
                            ...
                            <div class="dropdown-menu">
                                <div class="header-navheading">
                                    <h6 class="main-notification-title"><?php echo $_SESSION['AdminAdvocateEmail']; ?></h6>
                                    <p class="main-notification-text">Advocate</p>
                                </div>
                                
                                
                                
                                <a class="dropdown-item" href="<?php echo base_url('index.php/advocate/logout')?>">
...
<span class="main-img-user" ><img alt="avatar" src="../../assets/img/brand/ptt.png"></span>
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item" href="<?php echo base_url('index.php/Doctor/Login')?>">
                                        <i class="fe fe-power"></i> Sign Out
                                    </a>
                                </div>
                            </div>
            ...
            <div class="main-navbar hor-menu sticky">
                <div class="container">
                    <ul class="nav">
                         <li class="nav-item">
                            <a class="nav-link font-weight-semibold" href="advocate"> Dashboard</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link font-weight-semibold" href="clientlist_adv"> Client</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link font-weight-semibold" href="appointmentlist_adv"> Appointment</a>       
                        </li>
                        <li class="nav-item nav-item-mega">
                            <a class="nav-link font-weight-semibold" href="delete"> Contact</a>
                        </li>
                        <li class="nav-item">
                             <a class="nav-link font-weight-semibold" href="Clientuser_adv">Added Client</a>
                        </li>
