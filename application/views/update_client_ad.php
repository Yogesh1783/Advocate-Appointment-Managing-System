<!-- Main Content-->
            <div class="main-content pt-0">
                <div class="container">
                     <form  action="<?php echo base_url('index.php/admin/updateClient/'.$this->uri->segment(3)); ?>" method="POST">
...
<option <?php echo $client->CaseType=="Employment Case" ? "selected":""; ?> value="Employment Case">Employment Case</option>
                                            ...
                                            <div class="col-lg-4 mg-t-10 mg-lg-t-0 mb-3">
                                                ...
                                                <div class="col-md-9 mg-t-5 mg-md-t-0">
                                                    <input class="form-control" value="<?=$client->ClientName?>" name="ClientName" placeholder="" type="text">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-4 mg-t-10 mg-lg-t-0 mb-3">
                                                ...
                                                <div class="col-md-9 mg-t-5 mg-md-t-0">
                                                    <input class="form-control" value="<?=$client->ClientEmail?>" name="ClientEmail" placeholder="" type="text">
                                                </div>
                                            </div>   
                                        </div>
                                        ...
                                        <div class="row row-sm mg-t-20">
                                            <div class="col-lg-4 mg-t-10 mg-lg-t-0 mb-3">
                                                ...
                                                <div class="col-md-9 mg-t-5 mg-md-t-0">
                                                    <input class="form-control" value="<?=$client->ClientMobile?>" name="ClientMobile" placeholder="123456789" type="text">
                                                </div>
                                            </div>
                                             ...
                                             <div class="col-lg-4 mg-t-10 mg-lg-t-0 mb-3">
                                                ...
                                                <div class="col-md-9 mg-t-5 mg-md-t-0">
                                                    <input class="form-control" value="<?=$client->ClientAge?>" name="ClientAge" placeholder="" type="text">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-4 mb-3">
                                                <div class="row row-xs align-items-center mg-b-20">
                                                    <div class="col-md-3">
                                                     ...
                                                     <div class="col-md-9 mg-t-5 mg-md-t-0">
                                                <input class="form-control" value="<?=$client->ClientBirth?>" name="ClientBirth" placeholder="123456789" type="date">
                                                    </div>
                                                </div>
                                            </div>
...
<option <?php echo $client->ClientGender=="Female" ? "selected":""; ?> value="Female">Female</option>
                                             ...
                                             <div class="col-lg-4 mg-t-10 mg-lg-t-0 mb-3">
                                                ...
                                                <div class="col-md-9 mg-t-5 mg-md-t-0">
                                                    <input class="form-control" value="<?=$client->ClientPassword?>" name="ClientPassword" placeholder="" type="Password">
                                                </div>
                                            </div>
                                           ...
                                           <div class="col-lg-4 mg-t-10 mg-lg-t-0 mb-3">   
                                                ...
                                                <div class="col-md-9 mg-t-5 mg-md-t-0">
                                                    <input class="form-control" value="<?=$client->ClientAddress?>" name="ClientAddress" placeholder="" type="Textarea">
                                                </div>
                                            </div>
