                ...
                <div class="container">
                        ...
                        <div class="page-header">
                            <div class="page-header-1">
                                ...
                                <ol class="breadcrumb">
                                    <li style="color:white" class="breadcrumb-item active" aria-current="page">Appointment List</li>
                                </ol>
                            </div>
                             <div class="page-header-1">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table style="width:110%" id="example3" class="table table-striped table-bordered text-nowrap" >
                                                <thead>
                                                    <tr>
                                                        <th>sl no</th>
                                                        <th>date</th>
                                                    ...
                                                    <tr>
                                                       ...
                                                       <td><?php echo $appointment->AppointmentClientAdvocateEmail?></td>
                                                        ...
                                                        <td><a href="<?php echo base_url('index.php/Patient/update_appointment_pt/'.$appointment->AppointmentClientId)?>"><i  class="fe fe-edit-3"></i></a>
                                                            &nbsp;
                                                            <a data-target="#modaldemo2<?php echo $appointment->AppointmentClientId;?>" data-toggle="modal" ><i  class="fe fe-trash-2"></i></a></td>
                ...
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer justify-content-center">
                            <a href="<?php echo base_url('index.php/Admin/deleteAppointment/'.$appointment->AppointmentClientId)?>"><button 
